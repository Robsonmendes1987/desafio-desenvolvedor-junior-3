...
var find_all_post_exports = {};
__export(find_all_post_exports, {
  default: () => FindAllPost2
});
module.exports = __toCommonJS(find_all_post_exports);
...
function FindPost() {
  ...
  const FindPost2 = new FindAllPost(postRepository);
  return FindPost2;
}
